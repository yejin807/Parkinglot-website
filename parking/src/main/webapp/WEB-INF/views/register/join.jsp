        ...
        <body>
            <div class="container mt-5">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="tel" placeholder="10 ~ 11 자리의 숫자만 입력 가능합니다." name="tel">
                </div>
                ...
                <c:if test="${member.gubun == 'owner'}">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bizNum" placeholder="사업자번호" name="bizNum">
                    </div>
