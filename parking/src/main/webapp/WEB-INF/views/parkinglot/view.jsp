...
<div class="page">
	<div class="container">
		...
		<table class="table">
			...
			<tr>
				<th>주차장사진</th>
				<td><img alt="주차장사진" width="200px" height="200px"
					src="/${parkinglot.files}" /></td>
				<th>위치(지도)</th>
				<td>
			...
			<tr>
				...
				<td colspan="3"><fmt:formatNumber type="number"
						maxFractionDigits="3" value="${parkinglot.basicFee}"
						var="basicFee" /> ${basicFee}원</td>
			</tr>
			<tr>
				<th>일주차요금</th>
				<td><fmt:formatNumber type="number" maxFractionDigits="3"
						value="${parkinglot.dayFee}" var="dayFee" /> ${dayFee}원</td>
				<th>월주차요금</th>
				<td><fmt:formatNumber type="number" maxFractionDigits="3"
