                ...
                <div class="form-group mt-5">
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="parkingType" value="3" id="parkingType"
                                name="parkingType">월주차
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="parkingType" value="2" id="parkingType"
                                name="parkingType">주주차
                        </label>
                    </div>
                    <div class="form-check-inline disabled">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="parkingType" value="1" id="parkingType"
                                name="parkingType">일주차
                        </label>
                    </div>
                    <div class="form-check-inline disabled">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="parkingType" value="0" id="parkingType"
                                name="parkingType" checked="checked">자유주차
                        </label>
                    </div>
                </div>
